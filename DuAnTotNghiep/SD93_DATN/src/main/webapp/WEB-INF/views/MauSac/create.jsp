...
<html>
<head>
    <title>Quản Lý Màu Sắc Giày</title>
...
<div class="container">
    <h1
            style="color: red;">Thêm Màu Sắc Giày</h1>
    <br>
    <div>
        <form:form action="${pageContext.request.contextPath}/MauSac/create" modelAttribute="mauSac" enctype="multipart/form-data">
...
<br>
            <button type="submit" class="btn btn-success w-100" onclick="return confirm('Bạn chắc chắn muốn thêm không?');">
