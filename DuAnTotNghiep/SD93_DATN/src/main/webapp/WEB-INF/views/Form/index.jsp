...
<head>
    ...
    <title>Quản Lý Kiểu Dáng Giày</title>
    ...
    <style>
        ...
        th:nth-child(3){
            width: 12%; /* Set width for Ghi Chú */
        }
        ...
        th:nth-child(5) {
            width: 450px; /* Set width for Chức Năng */
        }
        th:nth-child(6) {
        ...
        th:nth-child(7) {
            width: 10%; /* Set width for Chức Năng */
        }
        .pagination {
            margin: 20px 0;
        }
        ...
        td {
            ...
            max-width: 200px; /* Giới hạn chiều rộng tối đa của ô ghi chú */
        }
...
<div class="container">
    <h1 style="color: red;">Quản Lý Kiểu Dáng Giày</h1>
<br>
<br>
    <div class="d-flex justify-content-between mb-3">
        <div class="search-form">
            <form action="/form/search" method="get" class="form-inline">
                <input type="text" class="form-control mr-2" name="tenForm" placeholder="Tìm kiếm kiểu dáng giày" style="width: 300px;">
                <button type="submit" class="btn btn-info"><i class="fas fa-search"></i> Tìm kiếm</button>
            </form>
        </div>

        <div class="filter-form">
            <form action="/form/filter" method="get" class="form-inline">
    ...
    <div class="text-left mb-3">
        <a href="/form/view-add" class="btn btn-primary btn-custom">
            <i class="fas fa-plus"></i> Thêm Mới Kiểu Dáng
        </a>
    </div>
        ...
        <table class="table table-striped table-bordered">
            ...
            <c:forEach items="${list}" var="d" varStatus="i">
                <tr>
                    ...
                    <td>${d.trangThai == 1 ? "✔" : "✖"}</td>
                    <td>
                        <a href="/form/detail/${d.id}" class="btn btn-info btn-custom-size">
    ...
    <div class="d-flex justify-content-center">
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                <li class="page-item">
                    <c:if test="${next > 0}">
                        <a class="page-link" href="/form/hien-thi?num=${next - 1}">
                ...
                <c:forEach begin="1" end="${totalPages}" varStatus="loop">
                    <li class="page-item ${loop.index == next + 1 ? 'active' : ''}">
                        <a class="page-link" href="/form/hien-thi?num=${loop.index - 1}">${loop.index}</a>
                    </li>
                </c:forEach>
                <li class="page-item">
                    <c:if test="${next < totalPages - 1}">
                        <a class="page-link" href="/form/hien-thi?num=${next + 1}">
