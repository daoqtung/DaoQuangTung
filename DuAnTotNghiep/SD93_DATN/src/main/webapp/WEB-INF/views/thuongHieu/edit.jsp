...
<div class="container">
    <h1
            style="color: red;">Cập Nhật Thương Hiệu Giày</h1>
    <div>
        <form:form action="/thuongHieu/update" modelAttribute="th" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn btn-success w-100">
                <i class="fas fa-edit"></i> Cập Nhật Thương Hiệu
            </button>
        </form:form>
    </div>
</div>
