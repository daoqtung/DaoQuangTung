                                    ...
                                    <ul class="pagination" style="margin-left: 470px; ">
                                        ...
                                        <c:choose>
                                            <c:when test="${currentPage > 1}">
                                                <li class="page-item" >
                                                    <a class="page-link" style="width: 50px" href="/TrangChu/listGiayTheThao?pageNum=${currentPage - 1}">Previous</a>
                                                </li>
                                            </c:when>
                                            <c:otherwise>
                                        ...
                                        <c:if test="${currentPage < totalPage}">
                                            <li class="page-item">
                                                <a href="/TrangChu/listGiayTheThao?pageNum=${currentPage + 1}" class="page-link" style="width: 50px">Next</a>                                            </li>
                                        </c:if>
                                    </ul>
                                </div>
                            </div>
