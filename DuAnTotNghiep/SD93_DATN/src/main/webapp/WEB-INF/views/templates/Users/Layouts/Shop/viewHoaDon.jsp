            ...
            <div class="row px-xl-5">
                ...
                <div class="col-lg-6">
                    <h5 class="section-title position-relative text-uppercase mb-3"><span
                            class="">Tổng số đơn hàng</span></h5>
                    <div class="bg-light p-30 mb-5">
                    ...
                    <div class="mb-5" style="background-color: #F8F9FA;margin-bottom: 30px">
                        <div class="payment-methods">
                            <label class="form-check-label" for="ctgg" >
                        ...
                        <div id="ctgg-details" style="margin-bottom: 20px">
                            <c:choose>
                                <c:when test="${not empty CTGG}">
                                    <select class="form-select" id="discountCombo" name="discount" style="margin-left: 0px;margin-top: 10px" onchange="updatePrice(this)">
                                        <option value="${list.thanhTien}"  selected>-- Chọn chương trình --</option>
                                        <c:forEach  items="${CTGG}" var="list">
                                            <%-- Hiển thị các mã khuyến mãi còn áp dụng --%>
                                            <c:if test="${list.trangThai == 1}">
                                                <option class="form-group" value="${list.phanTramGiam}" data-ten="${list.tenChuongTrinh}">
                                                        ${list.tenChuongTrinh} - ${list.phanTramGiam}%
                                                </option>
                                            </c:if>
                                        </c:forEach>
                                    </select>
                                ...
                                <c:otherwise>
                                    <p style="color: red; margin-left: 15px; font-size: 15px;">Không có mã khuyến mãi nào áp dụng cho mã hóa đơn này</p>
                                </c:otherwise>
                            </c:choose>
                        </div>
...
<%--                                    <c:forEach items="${CTGG}" var="list">--%>
<%--                                        &lt;%&ndash;                                            Hiện các mã khuyễn mãi còn để áp dụng&ndash;%&gt;--%>
<%--                                        <c:if test="${list.trangThai == 1}">--%>
<%--                                            <input style="margin-left: 15px" name="options" id="price" type="checkbox" value="${list.phanTramGiam}" onclick="updatePrice(this)"><span style="color: red">${list.tenChuongTrinh} </span> phần trăm giảm: <span style="color:  red">${list.phanTramGiam} %</span><br>--%>
                        ...
                        <div class="bg-light p-30">
                            <div class="form-group mb-4">
                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" value="momo" name="payment" id="banktransfer">
                                    <label class="custom-control-label" for="banktransfer" style="margin-top: 15px;margin-left: 15px">Thanh toán momo</label>
                                </div>
                            </div>
...
<script>
    ...
    if (loiHoaDonBySL == "2") {
        Swal.fire({
            icon: 'warning',
            html: '<div class="swal-text">Xin lỗi, sản phẩm trong hóa đơn của bạn nhiều hơn số lượng tồn</div><div class="progress-bar-container"></div>',
