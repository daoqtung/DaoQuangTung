    ...
    <div class="row" style="margin-top: 30px">
        ...
        <div class="col-12">
            <div class="row" style="width: 1160px; margin-top: 30px">
                <div class="col-1">
                    <img src="../../../../../../resources/img/banner/banner-img.webp" alt=""
                         style="width: 100px; border: 1px solid white; border-radius: 1000px 1500px 700px; margin-top: 22px">
                </div>
                <div class="col-3" style="margin-left: 30px">
                    <h4 style="margin-top: 15px">Easy-Shop</h4>
                    <a href="https://www.facebook.com/profile.php?id=100036371890565" style="text-decoration: none"
