        ...
        <form method="post">
            ...
            <table class="table" style="width: 100%">
                ...
                <c:forEach items="${page.content}" var="list">
                    <tr>
                        ...
                        <td>
                            <fmt:formatNumber type="" value="${list.thanhTien + list.phiShip - giamGia}" pattern="#,##0.###" /> VNĐ
                        </td>
            ...
            <ul class="pagination" style="width: 30px;height: 30px">
                <c:if test="${not page.first}">
                    <li class="page-item">
                        <a class="page-link" href="?pageNo=${page.number -1}" style="width: 30px;height: 40px">Pre</a>
                    </li>
                </c:if>
                ...
                <c:if test="${not page.last}">
                    <li class="page-item">
                        <a class="page-link" href="?pageNo=${page.number +1}" style="width: 30px;height: 40px">Next</a>
                    </li>
                </c:if>
            </ul>
        </form>
