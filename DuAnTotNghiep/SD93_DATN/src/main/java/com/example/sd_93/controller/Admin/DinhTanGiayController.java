...
import com.example.sd_93.model.DinhTanGiay;
import com.example.sd_93.repository.SanPham.AllGiayTheThao.DinhTanGiayRepository;
import com.example.sd_93.service.admin.DinhTanGiayService;
...
public class DinhTanGiayController {
    ...
    public String hienThi(Model model, @RequestParam(name = "num", defaultValue = "0") Integer num) {
        Page<DinhTanGiay> dtgPage = dinhTanGiayRepository.findAll(PageRequest.of(num, 5)); // Set page size to 5
