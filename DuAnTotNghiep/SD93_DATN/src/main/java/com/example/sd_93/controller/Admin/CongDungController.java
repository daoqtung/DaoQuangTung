...
import com.example.sd_93.repository.SanPham.AllGiayTheThao.CongDungRepository;
import com.example.sd_93.service.admin.CongDungService;
...
public class CongDungController {
    ...
    public String hienThi(Model model, @RequestParam(name = "num",defaultValue = "0") Integer num) {
        Page<CongDung> congDungPage = congDungRepository.findAll(PageRequest.of(num,5));
