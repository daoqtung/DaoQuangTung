...
import com.example.sd_93.repository.SanPham.AllGiayTheThao.DayGiayRepository;
import com.example.sd_93.service.admin.DayGiayService;
...
public class DayGiayController {
    ...
    public String hienThi(Model model, @RequestParam(name = "num",defaultValue = "0") Integer num) {
        Page<DayGiay> dayGiayPage = dayGiayRepository.findAll(PageRequest.of(num,5));
