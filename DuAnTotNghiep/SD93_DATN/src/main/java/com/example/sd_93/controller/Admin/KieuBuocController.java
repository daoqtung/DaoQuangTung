...
import com.example.sd_93.repository.SanPham.AllGiayTheThao.KieuBuocRepository;
import com.example.sd_93.service.admin.KieuBuocService;
...
public class KieuBuocController {
    ...
    public String hienThi(Model model, @RequestParam(name = "num",defaultValue = "0") Integer num) {
        Page<KieuBuoc> kieuBuocPage = kieuBuocRepository.findAll(PageRequest.of(num,5));
