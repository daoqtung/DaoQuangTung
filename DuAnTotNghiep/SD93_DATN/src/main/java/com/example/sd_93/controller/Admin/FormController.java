...
import com.example.sd_93.repository.SanPham.AllGiayTheThao.FormRepository;
import com.example.sd_93.service.admin.FormService;
...
public class FormController {
    ...
    public String hienThi(Model model, @RequestParam(name = "num",defaultValue = "0") Integer num) {
        Page<Form> formPage = formRepository.findAll(PageRequest.of(num,5));
